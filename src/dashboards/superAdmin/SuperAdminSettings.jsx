              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleSystemSettingChange("site_url", e.target.value)
                    }
                  />
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleSystemSettingChange("support_email", e.target.value)
                    }
                  />
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleSystemSettingChange("date_format", e.target.value)
                    }
                  >
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleSystemSettingChange("time_format", e.target.value)
                    }
                  >
                ...
                <Grid item xs={12}>
                  ...
                  <Typography
                    ...
                    sx={{ ml: 4 }}
                  >
                    Enable detailed error logging (not recommended for
                    production)
                  </Typography>
                </Grid>
              </Grid>
                ...
                {loading ? (
                  ...
                  <List dense>
                    ...
                    <ListItem>
                      <ListItemText
                        primary="Last Update"
                        secondary={systemInfo.last_update}
                      />
                    </ListItem>
                    <Divider component="li" />
                    ...
                    <ListItem>
                      <ListItemText
                        primary="Total Users"
                        secondary={systemInfo.total_users}
                      />
                    </ListItem>
                    <Divider component="li" />
                    ...
                    <ListItem>
                      <ListItemText
                        ...
                        secondary={systemInfo.total_schools}
                      />
                    </ListItem>
                    <Divider component="li" />
                    ...
                    <ListItem>
                      <ListItemText
                        ...
                        secondary={systemInfo.active_sessions}
                      />
                    </ListItem>
                    <Divider component="li" />
                    ...
                    <ListItem>
                      <ListItemText
                        ...
                        secondary={systemInfo.database_size}
                      />
                    </ListItem>
                    <Divider component="li" />
                    ...
                    <ListItem>
                      <ListItemText
                        ...
                        secondary={systemInfo.memory_usage}
                      />
                    </ListItem>
                  </List>
                ) : (
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4}>
            <Card>
              ...
              <CardActions>
                <Button fullWidth>Run Security Scan</Button>
              </CardActions>
            </Card>
                    ...
                    <Grid item xs={12}>
                      <FormControlLabel
                        control={
                          <Switch
                            checked={
                              notificationSettings.enable_sms_notifications
                            }
                            onChange={(e) =>
                              handleNotificationSettingChange(
                    ...
                    <Grid item xs={12}>
                      <FormControlLabel
                        control={
                          <Switch
                            checked={
                              notificationSettings.enable_push_notifications
                            }
                            onChange={(e) =>
                              handleNotificationSettingChange(
            ...
            <Card>
              <CardContent>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  ...
                  <Button variant="outlined">Send Test SMS</Button>

                  <Button variant="outlined">Test In-App Notification</Button>
                </Box>
              </CardContent>
            </Card>
              ...
              <Grid container spacing={3}>
                  ...
                  <FormControlLabel
                    control={
                      <Switch
                        ...
                        onChange={(e) =>
                          handleApiSettingChange("enable_api", e.target.checked)
                        }
                      />
                    }
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleApiSettingChange("api_rate_limit", e.target.value)
                    }
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleApiSettingChange("webhook_url", e.target.value)
                    }
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleApiSettingChange("webhook_secret", e.target.value)
                    }
            ...
            <Card sx={{ mt: 3 }}>
              <CardContent>
                ...
                <List dense>
                  <ListItem>
                    <ListItemText
                      primary="Total API Requests Today"
                      secondary="12,456"
                    />
                  </ListItem>
                  <Divider component="li" />
