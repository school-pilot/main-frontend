...
const API_BASE_URL =
  ...
  "https://school-pilot-api.vercel.app";
...
export const schoolsAPI = {
  ...
  update: (id, data) =>
    api.patch(`/api/schools/update/${id}/`, data),

  createSession: (data) =>
    api.post("/api/schools/session/create/", data),
  getSessions: (schoolId) =>
    api.get(`/api/schools/session/view/${schoolId}/`),
  updateSession: (id, data) =>
    api.patch(`/api/schools/session/update/${id}/`, data),

  createTerm: (data) =>
    api.post("/api/schools/term/create/", data),
  getTerms: (schoolId) =>
    api.get(`/api/schools/term/view/${schoolId}/`),
  getCurrentTerm: (schoolId) =>
    api.get(`/api/schools/term/current/${schoolId}/`),
  updateTerm: (id, data) =>
    api.patch(`/api/schools/term/update/${id}/`, data),
};
...
export const academicsAPI = {
  ...
  createArm: (data) =>
    api.post("/api/academics/arms/", data),
  subjects: () =>
    api.get("/api/academics/subjects/"),
  assignSubjects: (data) =>
    api.post("/api/academics/subjects/assign/", data),
};
...
export const resultsAPI = {
  assessments: () =>
    api.get("/api/results/assessments/"),
  enterScores: (data) =>
    api.post("/api/results/scores/", data),
  updateScore: (id, data) =>
    api.patch(`/api/results/scores/${id}/`, data),
  classResults: (params) =>
    api.get("/api/results/class/", { params }),
  approve: (data) =>
    api.post("/api/results/approve/", data),
  studentResults: (id) =>
...
export const feesAPI = {
  createCategory: (data) =>
    api.post("/api/fees/categories/", data),
  createStructure: (data) =>
    api.post("/api/fees/structures/", data),
  invoices: () =>
    api.get("/api/fees/invoices/"),
  invoice: (id) =>
    api.get(`/api/fees/invoices/${id}/`),
  payment: (data) =>
    api.post("/api/fees/payments/", data),
  paymentHistory: () =>
    api.get("/api/fees/payments/history/"),
};
...
export const communicationsAPI = {
  announcements: () =>
    api.get("/api/communications/announcements/"),
  createAnnouncement: (data) =>
    api.post("/api/communications/announcements/", data),
  notifications: () =>
    api.get("/api/communications/notifications/"),
  markRead: (id) =>
    api.patch(
      `/api/communications/notifications/${id}/read/`
    ),
};
...
export const timetableAPI = {
  ...
  class: (id) =>
    api.get(`/api/timetable/class/${id}/`),
  teacher: (id) =>
...
export const subscriptionsAPI = {
  ...
  upgrade: (data) =>
    api.post("/api/subscriptions/upgrade/", data),
};
